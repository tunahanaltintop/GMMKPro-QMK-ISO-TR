...
- Additionally, you can download the MacOS ISO Turkish (TR) layout legend design for your cherry profile keycaps from the "MacOS_ISO_TR.pdf" file. You can print this design in A4 format. You can check out [@YOHON!'s][youtube-yohon] video for water slide decal.
