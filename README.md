...
- Additionally, you can download the MacOS ISO Turkish (TR) layout legend design (which is with my IntellijIdea keymap configuration icons) for your cherry profile keycaps from the "[Mac_ISO_TR.pdf](https://github.com/tunahanaltintop/GMMKPro-QMK-ISO-TR/blob/main/Mac_ISO_TR.pdf)" file. You can print this design in A4 format. You can check out [@YOHON!'s][youtube-yohon] video for water slide decal.
